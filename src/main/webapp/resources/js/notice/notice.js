                ...
                $.ajax({
                    ...
                    success : function(result){
                        if(result != null){
                            ...
                            // console.log(result.allNoticeList.noticeType);
                            console.log(result.allNoticeList[0].noticeType);
                            ...
                            for(let i = paging.startPage;i<=paging.endPage;i++){
                                ...
                                a.setAttribute("onclick", "noticeType(" + i + ")");
                                pageNumber.append(a);
                                paginationUl.append(pageNumber);

                                a.classList.add("type");

                                a.setAttribute("value", result.allNoticeList[i-1].noticeType);

                                // console.log(i)
                                // console.log(result.allNoticeList[i-1]);
                                // console.log(result.allNoticeList[i].noticeType);
                                // console.log(a);
