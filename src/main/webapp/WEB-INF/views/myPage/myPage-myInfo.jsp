            ...
            <div class="myPage-profile-area">
                <div class="myPage-profile">
                    ...
                    <div class="myPage-image-area">
                        <form action="#" method="POST" enctype="multipart/form-data" onsubmit="return profileValidate()">
                            ...
                            <div class="image-btn-area">
                                <button>변 경</button>
                                <button type="reset" id="delete-image">취 소</button>
                            </div>
